...
const SummarySection = ({
  ...
  <section className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-sm">
    <div className={`flex items-center justify-between border-b border-slate-100 px-6 py-5 ${tone}`}>
      <div>
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Live Database Summary</p>
  ...
  return (
    ...
    >
      <div className="mb-6 grid grid-cols-1 gap-4 xl:grid-cols-3">
        <div className="rounded-[1.75rem] border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6 text-white shadow-xl">
          <p className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-300">Database Snapshot</p>
          ...
          <div className="mt-5 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] text-emerald-300">
            <Database size={14} />
        ...
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">Overall Commercial</p>
          <div className="mt-4 grid grid-cols-2 gap-4">
            <SummaryMetric label="Month Sales" value={formatCurrency(summary?.sales?.monthSales || 0)} accent="text-emerald-700" />
            <SummaryMetric label="PCD Verified Sales" value={formatCurrency(summary?.pcd?.verifiedSales || 0)} accent="text-blue-700" />
        ...
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">Operational Alerts</p>
          <div className="mt-4 space-y-3">
            <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3">
              <TriangleAlert size={18} className="mt-0.5 text-amber-600" />
              <div>
                <p className="text-sm font-black text-amber-900">{formatNumber(summary?.inventory?.lowStockProducts || 0)} low-stock products</p>
            ...
            <div className="flex items-start gap-3 rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3">
              ...
              <div>
                <p className="text-sm font-black text-rose-900">{formatNumber(summary?.dms?.expiringDocuments || 0)} expiring documents</p>
            ...
            <div className="flex items-start gap-3 rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3">
              <ArrowUpRight size={18} className="mt-0.5 text-blue-600" />
              <div>
                <p className="text-sm font-black text-blue-900">{formatNumber(summary?.crm?.highPriorityLeads || 0)} high-priority CRM leads</p>
      ...
      <div className="grid grid-cols-1 gap-6 2xl:grid-cols-2">
        <SummarySection
          ...
          tone="bg-gradient-to-r from-emerald-50 to-white"
        >
          ...
          <SummaryMetric label="Income" value={formatCurrency(summary?.accounts?.totalIncome || 0)} accent="text-blue-700" />
        ...
        <SummarySection
          ...
          icon={<Boxes size={22} />}
          tone="bg-gradient-to-r from-blue-50 to-white"
        >
          ...
          <SummaryMetric label="Stock Value" value={formatCurrency(summary?.inventory?.totalStockValue || 0)} accent="text-blue-700" />
        ...
        <SummarySection
          ...
          icon={<Users size={22} />}
          tone="bg-gradient-to-r from-violet-50 to-white"
        >
        ...
        <SummarySection
          ...
          tone="bg-gradient-to-r from-cyan-50 to-white"
        >
        ...
        <SummarySection
          ...
          tone="bg-gradient-to-r from-amber-50 to-white"
        >
        ...
        <SummarySection
          ...
          tone="bg-gradient-to-r from-rose-50 to-white"
        >
      ...
      <div className="mt-6 rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">Quick Read</p>
            <h3 className="text-lg font-black text-slate-900">What the database says right now</h3>
          </div>
        </div>
