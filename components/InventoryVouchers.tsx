                  ...
                  <div className="flex-1 flex overflow-hidden">
                     ...
                     {selectedItem && (
                        <div className="w-64 bg-slate-50 p-4 border-l border-slate-200 overflow-auto animate-in slide-in-from-right-4 duration-300 shadow-inner">
                           <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4 border-b pb-2 flex items-center justify-between">
                                 ...
                                 return (
                                    <div key={b.id} className={`p-2 rounded border bg-white shadow-sm transition-all hover:ring-2 hover:ring-blue-500/20 cursor-pointer ${isNearExpiry ? 'border-red-200' : 'border-slate-200'}`}>
                                       <div className="flex justify-between items-start mb-1">
                                          <span className="text-xs font-black text-slate-700">{b.no}</span>
                           ...
                           <div className="mt-6 pt-4 border-t border-slate-200">
                              <div className="text-[10px] font-black text-purple-600 uppercase mb-2 text-center">Applied Scheme</div>
                              <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded p-3 text-center text-sm font-black shadow-lg">
                           ...
                           <div className="mt-6 pt-4 border-t border-slate-200 font-mono text-[10px] space-y-2">
                              ...
                              <div className="flex justify-between mt-2 pt-2 border-t border-slate-100 font-bold text-blue-600 text-xs">
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm flex-1 flex flex-col h-full overflow-hidden">
       <div className="p-4 border-b border-slate-200 flex justify-between items-center bg-slate-50 shrink-0">
          <div>
            <h3 className="text-lg font-black text-slate-800 tracking-tight">Inventory Vouchers</h3>
       ...
       <div className="flex-1 overflow-auto">
          <table className="w-full text-left border-collapse text-sm">
             <thead className="bg-[#E4ECEF] sticky top-0 border-b border-slate-300 shadow-sm text-xs uppercase tracking-wider text-slate-600">
                 <tr>
                    <th className="p-3 font-black border-r border-white/50 w-32">Date</th>
                    <th className="p-3 font-black border-r border-white/50 w-32">Voucher No</th>
                    <th className="p-3 font-black border-r border-white/50 w-24">Type</th>
