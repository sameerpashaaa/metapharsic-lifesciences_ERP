  ...
  if (!dbStatus.connected) {
    return (
      <div className="p-12 text-center">
        ...
        <button onClick={handleRefresh} className="mt-6 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
          Retry Connection
        </button>
      </div>
    );
    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
              <Package size={20} className="text-blue-600"/> Package Type Distribution
            </h3>
      ...
      {activeTab === 'REPORTS' && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 text-center hover:shadow-md transition-shadow">
        ...
        >
          <form onSubmit={handleAddDispatch} className="space-y-4">
            ...
            <div className="pt-4 border-t flex justify-end gap-2">
              ...
              <button 
                type="submit"
                className="px-6 py-2 bg-blue-600 text-white rounded text-sm font-bold hover:bg-blue-700"
              >
                Save Dispatch
              </button>
            </div>
