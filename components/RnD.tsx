        ...
        <div className="space-y-6 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {paginatedData.map((f: any) => (
              <div key={f.id} className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow group">
        ...
        <div className="mt-6">
          <DataTable 
            columns={[
              ...
              { key: 'actions', label: 'Actions', width: '10%', render: () => <button className="text-blue-600 hover:underline">Details</button> }
            ]}
            data={experiments}
