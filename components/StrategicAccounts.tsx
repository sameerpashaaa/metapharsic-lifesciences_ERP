    ...
    if (loadingParties) {
      return (
        <div className="h-full flex flex-col items-center justify-center space-y-4">
          ...
          <p className="text-xs font-black text-slate-400 uppercase tracking-[0.3em]">Hydrating Financial Core...</p>
        </div>
      );
    }
        ...
        return (
          <div className="space-y-8 animate-fadeIn">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-3xl font-black text-slate-800 tracking-tight uppercase">Financial Dashboard</h2>
