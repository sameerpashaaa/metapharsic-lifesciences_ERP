    ...
    },
    {
      ...
      render: (_, row: AgingRecord) => (
        <button 
          ...
          className="text-xs flex items-center justify-center gap-1 bg-slate-100 hover:bg-blue-100 hover:text-blue-700 text-slate-600 px-2 py-1 rounded w-full font-bold transition-colors"
        >
