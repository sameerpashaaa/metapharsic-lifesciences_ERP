...
const DailySalesIntelligence: React.FC = () => {
 ...
 <p className="text-xs text-rose-600 mt-1 uppercase font-bold">Verify database sales entries & token integrity</p>
 ...
 <p className="text-xl font-bold text-slate-800">{formatCurrency(summary.total_period_revenue)}</p>
 </div>
 </div>
 ...
 <p className="text-xl font-bold text-slate-800">{formatCurrency(summary.total_period_profit)}</p>
 </div>
 </div>
 ...
 <p className="text-xl font-bold text-slate-800">{summary.average_margin}%</p>
 </div>
 </div>
 </div>

 {/* Primary Intelligence Chart */}
 <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-none shadow-slate-100/50">
 <div className="flex justify-between items-center mb-8">
 <div>
 <h4 className="text-lg font-bold text-slate-800 tracking-tight">Daily Performance Analytics</h4>
 ...
 <td className="py-4 text-right text-emerald-600">{formatCurrency(row.gross_profit)}</td>
