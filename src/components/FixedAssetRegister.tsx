      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4">
        ...
        <div className="grid grid-cols-4 gap-4 mt-4">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
            <div className="flex items-center justify-between">
              <span className="text-blue-700 text-sm font-medium">Current Year Dep.</span>
              <Calculator size={18} className="text-blue-600" />
            </div>
            <div className="text-2xl font-bold text-blue-800 mt-1">
              {formatCurrency(summaryStats.currentYearDep)}
            </div>
            <div className="text-xs text-blue-600 mt-1">FY 2025-26</div>
          </div>
        </div>
      </div>
                    ...
                    <tr key={asset.id} className="hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 text-center">
                        <span className={`px-2 py-1 rounded text-xs ${
                          asset.depreciationMethod === 'SLM' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'
                        }`}>
                      ...
                      <td className="px-4 py-3 text-center">
                        <button className="text-blue-600 hover:text-blue-800 mr-2"><Edit3 size={16} /></button>
            ...
            <div className="bg-white rounded-lg border border-slate-200 p-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <p className="text-blue-700">All assets depreciated for full year FY 2025-26 (365 days)</p>
                </div>
