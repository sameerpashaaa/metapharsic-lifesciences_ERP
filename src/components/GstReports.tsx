...
export const GstReports: React.FC = () => {
 ...
 <h4 className="font-bold text-[#1D3557] flex items-center gap-2"><FileText size={18}/> Form {reportType}</h4>
 ...
 <td className="p-3 border-r border-slate-200 text-right font-bold text-slate-700">{r.igst > 0 ? r.igst.toLocaleString() : '-'}</td>
 <td className="p-3 border-r border-slate-200 text-right font-bold text-slate-700">{r.cgst > 0 ? r.cgst.toLocaleString() : '-'}</td>
 <td className="p-3 border-r border-slate-200 text-right font-bold text-slate-700">{r.sgst > 0 ? r.sgst.toLocaleString() : '-'}</td>
 <td className="p-3 text-right font-bold text-slate-700">{r.cess > 0 ? r.cess.toLocaleString() : '-'}</td>
 </tr>
 ))}
 </tbody>
 </table>
 ...
 <span className="font-bold">Details for row {drillDown}</span>
 </div>
 ...
 <th className="p-3 font-bold border-r border-slate-200">Party / GSTIN</th>
