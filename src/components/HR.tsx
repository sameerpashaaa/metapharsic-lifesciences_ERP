...
const HR: React.FC = () => {
 ...
 <div 
 className={`h-full ${v >= 100 ? 'bg-green-500' : 'bg-accent'}`} 
 ...
 <TrendingUp className="mx-auto mb-4 text-accent opacity-20" size={48}/>
 ...
 <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center text-accent">
 <Users size={32}/>
 </div>
 <div>
