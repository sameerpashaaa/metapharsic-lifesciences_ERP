...
const Inventory: React.FC = () => {
 ...
 await refetch();
 notify.success('Inventory refreshed from database');
 };
 ...
 notify.error('Failed to fetch batch details');
 }
 };
 ...
 if (response.ok) {
 notify.success('Adjustment recorded successfully');
 setShowAdjustmentModal(false);
 refetch();
 }
 } catch (err) {
 notify.error('Failed to record adjustment');
 }
 };
 ...
 {/* ============================================================ */}
 {activeTab === 'VALUATION' && (
 <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center text-accent">
