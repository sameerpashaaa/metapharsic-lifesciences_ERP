...
const InventoryAnalytics: React.FC = () => {
 ...
 className="bg-accent text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 hover:bg-accent transition-colors shadow-sm"
 >
 ...
 <div key={v.id} className="bg-white rounded-xl border border-slate-200 overflow-hidden flex flex-col h-96">
 <div className={`p-4 bg-slate-50 border-b border-slate-100 flex justify-between items-center`}>
 <h4 className={`font-bold text-slate-700`}>{v.label}</h4>
 <span className="text-xs font-bold opacity-50">{v.data?.length || 0}</span>
 </div>
 ...
 <div>
 <p className="text-xs font-bold text-rose-600 uppercase tracking-widest mb-1">Expired Units</p>
 <h3 className="text-3xl font-bold text-rose-700">{data?.expiryLifecycle?.expired?.length || 0}</h3>
 </div>
 ...
 <div>
 <p className="text-xs font-bold text-amber-600 uppercase tracking-widest mb-1">Near Expiry (180D)</p>
 <h3 className="text-3xl font-bold text-amber-700">{data?.expiryLifecycle?.nearExpiry?.length || 0}</h3>
 </div>
 ...
 >
 <div className="p-2">
 <div className="bg-accent rounded-xl p-6 text-white mb-6 relative overflow-hidden">
 ...
 <div className="flex items-start gap-4 p-4 border border-slate-100 rounded-xl">
 <div className="p-2 bg-blue-50 text-accent rounded-lg"><Zap size={20}/></div>
 <div>
 ...
 disabled={optimizing}
 className="w-full bg-[#1D3557] text-white py-4 rounded-xl font-bold uppercase tracking-widest shadow-none shadow-none hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-3"
 >
