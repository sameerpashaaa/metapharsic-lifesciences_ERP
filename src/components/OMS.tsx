  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, row: any) => (
        <button onClick={() => handleViewDetail(row)} className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
          <Eye size={18} />
        </button>
      )
    }
            ...
            <div className="col-span-2 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3 max-h-[400px] overflow-y-auto p-1">
                  {products?.map((p: any) => (
                    <div key={p.id} className="p-3 border border-slate-100 rounded-lg hover:border-blue-500 cursor-pointer transition-colors flex justify-between items-center group" onClick={() => addToCart(p)}>
                      <div>
