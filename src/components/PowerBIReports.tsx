            ...
            {forecastingTemplates.map((template) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full mt-3 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {generatingForecast ? (
                    <>
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {forecastData.map((row, idx) => (
                        <tr key={idx}>
                          ...
                          <td className="p-2 text-right font-bold text-blue-600">₹{row.forecast.toLocaleString()}</td>
