          ...
          {activeTab === 'START' && (
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex gap-3">
                <Warehouse className="text-blue-600 shrink-0" size={20} />
                      ...
                      <tr key={item.id} className="hover:bg-slate-50">
                        ...
                        <td className="p-3 text-center">
                          <button
                            ...
                            className="inline-flex items-center gap-1 text-blue-600 hover:text-blue-700 hover:bg-blue-50 px-2 py-1 rounded"
                          >
                            <Eye size={15} />
                            Open
                          </button>
