...
const StrategicPCD: React.FC = () => {
 ...
 <div className="font-bold text-slate-700">₹{Number(val).toLocaleString()}</div>
 )},
 { key: 'actions', label: 'Action', width: '10%', align: 'right' as const, format: (_: any, row: any) => (
 <button onClick={() => setSelectedPartner(row)} className="p-2 text-accent hover:bg-blue-50 rounded-lg">
 <Eye size={16} />
 </button>
 )}
 ];
 ...
 <h3 className="font-bold text-slate-800 mb-6 flex items-center gap-2 uppercase tracking-widest text-xs opacity-50">
 <Building2 size={16}/> Partner Intelligence
 </h3>
 <div className="grid grid-cols-2 gap-8">
 <div className="space-y-4">
 <div>
 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Assigned Territory</p>
 <div className="flex items-center gap-2 text-slate-900 font-bold">
 <MapPin size={16} className="text-accent"/> {selectedPartner.territory}
 </div>
 </div>
 <div>
 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Contact Hub</p>
 ...
 <div className="space-y-4">
 <div>
 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Compliance & License</p>
 <div className="flex items-center gap-2">
 <span className="text-xs font-bold bg-slate-100 px-2 py-1 rounded-lg font-mono">DL: {selectedPartner.drug_license_no}</span>
 <span className="text-xs font-bold bg-slate-100 px-2 py-1 rounded-lg font-mono">GST: {selectedPartner.gstin}</span>
 </div>
 </div>
 <div>
 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Financial Metrics</p>
 <div className="flex justify-between items-end">
 <div>
 <p className="text-2xl font-bold text-slate-900">₹{Number(selectedPartner.credit_limit).toLocaleString()}</p>
 ...
 <h3 className="font-bold text-slate-800 flex items-center gap-2 uppercase tracking-widest text-xs opacity-50">
 <Users size={16}/> Field Force Assignment
 </h3>
 <button onClick={() => setShowAssignMRModal(true)} className="text-xs font-bold bg-accent text-white px-3 py-1.5 rounded-lg hover:bg-accent transition-all flex items-center gap-1.5">
 ...
 {assignedMrs.map(mr => (
 <div key={mr.id} className="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-100">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 bg-white rounded-xl shadow-sm border border-slate-100 flex items-center justify-center font-bold text-accent">
 {mr.name.charAt(0)}
 </div>
 <div>
 ...
 <div className="bg-slate-900 text-white p-6 rounded-xl shadow-none shadow-slate-200 relative overflow-hidden">
 <div className="relative z-10">
 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Performance Radar</p>
 <div className="mb-6">
 <h4 className="text-4xl font-bold mb-1">₹3,50,000</h4>
 ...
 <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
 <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2 uppercase tracking-widest text-xs opacity-50">
 ...
 <span className="text-xs font-bold text-slate-900">4.2x / mo</span>
 </div>
 <div className="flex items-center justify-between">
 <span className="text-xs font-bold text-slate-500">Average Pay Days</span>
 <span className="text-xs font-bold text-slate-900">28 Days</span>
 </div>
 </div>
 </div>
 </div>
 ...
 className="w-full py-3 bg-slate-900 text-white rounded-xl font-bold text-sm shadow-none hover:bg-accent transition-all flex items-center justify-center gap-2"
 >
 ...
 <StatCard label="Active Partners" value={dashboardStats?.active_partners || 0} icon={<Users className="text-accent" size={24}/>} color="blue" trend="+2 New" />
 ...
 <div className="bg-accent h-full rounded-full" style={{width: `${Math.min(100, pct)}%`}}></div>
 </div>
 </div>
 );
 })}
 ...
 <h3 className="font-bold text-slate-800 uppercase tracking-widest text-lg">Detailed View Pending</h3>
 ...
 <button className="mt-6 text-sm font-bold text-accent bg-blue-50 px-6 py-2 rounded-xl hover:bg-blue-100 transition-all">Request Priority Enablement</button>
 </div>
 )}
 ...
 <div className="bg-accent rounded-xl p-8 text-white shadow-none relative overflow-hidden">
 ...
 <button className="px-8 py-4 bg-white text-blue-900 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-none">
 Ask AI
 </button>
 </div>
 ...
 r.ai_verdict.includes('Moderate') ? 'bg-blue-100 text-accent' :
 ...
 <div className="space-y-4">
 <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest border-b pb-2">Identification</h4>
 <div className="space-y-2">
 ...
 <div className="space-y-4">
 <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest border-b pb-2">Compliance</h4>
 <div className="space-y-2">
 ...
 <button type="submit" disabled={isSaving} className="px-10 py-3 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-accent transition-all shadow-none flex items-center gap-2">
